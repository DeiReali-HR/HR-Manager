...
st.markdown("""
<style>
    /* Stile per la vetrina */
    .vetrina-box { background-color: #EFF6FF; padding: 20px; border-radius: 12px; border: 1px solid #DBEAFE; margin-bottom: 30px; display: grid; grid-template-columns: repeat(7, 1fr); gap: 10px; }
...
def mostra_portale():
    ...
    if evidenza:
        ...
        # Utilizziamo un blocco unico HTML per garantire lo sfondo azzurro dietro le 7 card
