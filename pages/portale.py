...
<style>
    ...
    .img-lato { width: 200px; min-width: 200px; height: 280px; background-size: cover; background-position: center; border-radius: 2px; }
...
def mostra_portale():
    # Intestazione editoriale al posto del titolo elementare
    ...
    # 2. LISTA (Stile sobrio editoriale)
