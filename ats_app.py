...
# --- AREA AMMINISTRATIVA ---
    ...
    with scelta_tab[8]:
        ...
        if not annunci_attivi:
            ...
            # Creiamo il layout di Streamlit a colonne per inserire i box HTML ordinati
            ...
            with col_v1:
                ...
                for idx, a in enumerate(annunci_attivi):
                    ...
                    # Elementi nativi di Streamlit per espandere ed effettuare la candidatura immediata
            ...
            with col_v2:
                # Box laterale informativo della bacheca aziendale
                st.markdown(f"""
