...
# --- AREA AMMINISTRATIVA / BACKOFFICE ---
    ...
    if not st.session_state.autenticato:
        ...
        # --- TAB 9: PORTALE CARRIERE (RIGIDA GRIGLIA ED ALLINEAMENTO ORIZZONTALE) ---
        with scelta_tab[8]:
            ...
            st.markdown("""
            <style>
            /* Forza il contenitore Streamlit a mostrare i blocchi su una sola riga flessibile */
            ...
            /* Ogni item occupa un ottavo dello spazio disponibile */
            .vetrina-item {
                display: flex !important;
            ...
            .vetrina-solo-img:hover { transform: translateY(-4px) !important;
