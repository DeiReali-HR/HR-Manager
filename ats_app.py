...
tab_nomi = ["🏠 Home / Plancia","📢 Annunci", "🔬 Screening", "🤝 Colloqui", "💼 Assunzioni", "📊 Report", "👥 Clienti", "👥 Candidati", "🌐 Vetrina Carriere (Web)", "👑 Appalti"] scelta_tab = st.tabs(tab_nomi)
        ...
        with scelta_tab[9]:
            ...
            if res_ass.data:
                ...
                if filtro_cliente != "Tutti i Clienti":
                    df_filtrato = df_assunzioni[df_assunzioni['cliente_distacco'] == filtro_cliente]
                else:
                    df_filtrato = df_assunzioni
